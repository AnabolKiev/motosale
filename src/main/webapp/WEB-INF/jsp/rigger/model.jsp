        ...
        <div class="content">
            ...
            <table class="specs-table">
                <c:if test="${!(
                                ...
                                empty model.fuelSystem &&
                                empty model.coolingType.name &&
                                empty model.fuelControl &&
                                empty model.valverPerCylinder &&
                                empty model.lubrications &&
                                empty model.oilCapacity)}">
                    <tr>
                        <td>
                ...
                <c:if test="${!(empty model.power &&
                                empty model.torque &&
                                empty model.topSpeed &&
                                empty model.maxRPM &&
                                empty model.acceleration100 &&
                                empty model.acceleration60_140 &&
                                empty model.quoterTime &&
                                empty model.powerWeight)}">
                    <tr>
                        <td>
                            <div class="specs-table-group">
                ...
                <c:if test="${!(empty model.height &&
                                empty model.length &&
                                empty model.width &&
                                empty model.dryWeight &&
                ...
                <c:if test="${!(empty model.frontBrakes &&
                                empty  model.rearBrakes &&
                                empty  model.frontBrakesDiameter &&
                                empty model.rearBrakesDiameter)}">
                    <tr>
                        <td>
                            <div class="specs-table-group">
                                <h4>Тормоза</h4>
                ...
                <c:if test="${!(empty model.frontSuspension &&
                                empty model.rearSuspension &&
                                empty model.frontTravel &&
                                empty model.rearTravel)}">
                    <tr>
                        <td>
                            <div class="specs-table-group">
                                <h4>Подвеска</h4>
